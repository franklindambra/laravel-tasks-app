...
<head>
    ...
    <style type="text/tailwindcss">
        .btn {
            @apply rounded-md px-2 py-1 text-slate-700 text-center font-medium shadow-sm ring-1 ring-slate-700/10 hover:bg-slate-500;
        }
...
<body class="container mx-auto mt-10 mb-10 max-w-lg">
    <h1 class="txt-2xl mb-4">@yield('title')</h1>
